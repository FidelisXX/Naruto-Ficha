...
3. ⬜ Fluxo separado de **Customizar Jutsu existente** (p.152-155): regras já extraídas (tabelas de custo incremental de componente/palavra-chave/alcance/efeito, fórmula dano-médio→rank), UI ainda não construída.
